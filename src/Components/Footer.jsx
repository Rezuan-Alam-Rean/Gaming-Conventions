...
const Footer = () => {
  ...
  <nav>
    <header className="footer-title">Games</header> 
    <a className="link link-hover">Pubg</a> 
    
    <a className="link link-hover">PES</a> 
...
<footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
  <aside className="items-center grid-flow-col">
    ...
    <p>Game Industries Ltd. <br/>Providing reliable tech since 2002</p>
  </aside> 
